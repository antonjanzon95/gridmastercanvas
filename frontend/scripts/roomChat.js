...
//         <button id='room-send-button' class="send-button">Send</button>
//     </div>
//   `;
...
//   let sendButton = document.querySelector("#room-send-button");
...
//     const messageAndUserAndRoomId = {
//       message: sendMessage.value,
//       user: JSON.parse(sessionStorage.getItem("user")),
//       roomId: room.roomId,
//     };
//     socket.emit("localMessage", messageAndUserAndRoomId);
//     sendMessage.value = "";
//   });

//   socket.on("monitorRoomMessages", () => {
//     if (user.activeChat != "local") {
//       return;
//     }
